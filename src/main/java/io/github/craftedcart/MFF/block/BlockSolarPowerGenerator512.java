...
public class BlockSolarPowerGenerator512 extends ModBlock implements ITileEntityProvider {

    public BlockSolarPowerGenerator512() {

        super();
        this.setUnlocalizedName(Names.BlockSolarPowerGenerator512);
        this.setHardness(4f);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        ...
        tepg.initSolar(PowerConf.solarPowerGeneratorBaseGenRate * 512);
        return tepg;
    }
