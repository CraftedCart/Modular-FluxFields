package io.github.craftedcart.MFF.client.gui.blockconfig;

import io.github.craftedcart.MFF.client.gui.guiutils.*;
import io.github.craftedcart.MFF.handler.NetworkHandler;
import io.github.craftedcart.MFF.network.MessageSetInputSide;
import io.github.craftedcart.MFF.network.MessageSetOutputSide;
...
public class GuiConfigPowerRelay extends UIDisplay {
    ...
    public void onInit() {
        ...
        final UILabel titleLabel = new UILabel(titleComponent,
                ...
                new AnchorPoint(0, 0),
                GuiUtils.font);
        titleLabel.setText(StatCollector.translateToLocal("gui.mff:powerRelayConfig"));
        ...
        final UILabel powerLabel = new UILabel(powerComponent,
                ...
                new AnchorPoint(0, 0),
                GuiUtils.font);
        powerLabel.setText(String.format("%s: %.2f / %.2f %s", StatCollector.translateToLocal("gui.mff:power"),
                te.power, te.maxPower, StatCollector.translateToLocal("gui.mff:fe")));
        ...
        final UILabel inputSideLabel = new UILabel(inputSideLabelComponent,
                ...
                new AnchorPoint(0, 0),
                GuiUtils.font);
        inputSideLabel.setText(String.format("%s: %s", StatCollector.translateToLocal("gui.mff:inputSide"),
        ...
        final UILabel outputSideLabel = new UILabel(outputSideLabelComponent,
                ...
                new AnchorPoint(0, 0),
                GuiUtils.font);
        outputSideLabel.setText(String.format("%s: %s", StatCollector.translateToLocal("gui.mff:outputSide"),
