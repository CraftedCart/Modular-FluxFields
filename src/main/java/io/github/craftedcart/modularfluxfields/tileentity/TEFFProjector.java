...
import io.github.craftedcart.modularfluxfields.damagesource.DamageSourceFFSecurityKill;
...
import io.github.craftedcart.modularfluxfields.init.ModEntityTracker;
...
public class TEFFProjector extends TEPoweredBlock implements IUpdatePlayerListBox, IInventory {
    ...
    public String getName() {
        return this.hasCustomName() ? this.customName : "container.modularfluxfields:ffProjector";
    }
