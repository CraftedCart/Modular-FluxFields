...
public class BlockSolarPowerGenerator64 extends ModBlock implements ITileEntityProvider {

    public BlockSolarPowerGenerator64() {

        super();
        this.setUnlocalizedName(Names.BlockSolarPowerGenerator64);
        this.setHardness(4f);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        ...
        tepg.initSolar(PowerConf.solarPowerGeneratorBaseGenRate * 64);
        return tepg;
    }
