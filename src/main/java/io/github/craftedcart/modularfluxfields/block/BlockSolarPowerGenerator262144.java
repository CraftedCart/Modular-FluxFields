 ...
 */
public class BlockSolarPowerGenerator262144 extends ModBlock implements ITileEntityProvider {

    public BlockSolarPowerGenerator262144() {

        super();
        this.setUnlocalizedName(Names.BlockSolarPowerGenerator262144);
        this.setHardness(4f);
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        ...
        tepg.initSolar(PowerConf.solarPowerGeneratorBaseGenRate * 262144);
        return tepg;
    }
