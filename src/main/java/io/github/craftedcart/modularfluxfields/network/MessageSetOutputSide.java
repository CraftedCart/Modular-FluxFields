 ...
 */
public class MessageSetOutputSide implements IMessage {

    private BlockPos pos;
    private EnumFacing enumFacing;

    public MessageSetOutputSide() {}

    public MessageSetOutputSide(BlockPos pos, EnumFacing enumFacing) {
        this.pos = pos;
    ...
    public static class Handler implements IMessageHandler<MessageSetOutputSide, IMessage> {

        @Override
        public IMessage onMessage(final MessageSetOutputSide message, final MessageContext ctx) {
            ...
            mainThread.addScheduledTask(new Runnable() {
                ...
                public void run() {
                    ...
                    te.setOutputSide(message.enumFacing);
