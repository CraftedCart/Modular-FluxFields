...
public class ShaderUtils {
    ...
    public static void init() {
        ...
        try {
            ...
            BufferedReader reader = new BufferedReader(new InputStreamReader(Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("modularfluxfields:shaders/specular.vert")).getInputStream()));
            ...
            reader = new BufferedReader(new InputStreamReader(Minecraft.getMinecraft().getResourceManager().getResource(new ResourceLocation("modularfluxfields:shaders/specular.frag")).getInputStream()));
