...
public class GuiFFProjectorSecurity extends GuiFFProjectorBase {
    ...
    public void onInit() {
        ...
        setTitle(StatCollector.translateToLocal("gui.modularfluxfields:security"));
        ...
        if (te.hasSecurityUpgrade) {
            ...
            addPlayerTextField.setPlaceholderText(StatCollector.translateToLocal("gui.modularfluxfields:addPlayer"));
            ...
            final UITextField addPermGroupTextField = new UITextField(getWorkspace(),
                    ...
                    new AnchorPoint(0, 0),
                    new AnchorPoint(0.4, 0));
            addPermGroupTextField.setPlaceholderText(StatCollector.translateToLocal("gui.modularfluxfields:addPermGroup"));
            ...
            final UILabel permGroupsTitleLabel = new UILabel(getWorkspace(),
                    ...
                    GuiUtils.font);
            permGroupsTitleLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:permGroups"));
            ...
            tasksComponent.setOnUpdateAction(new UIAction() {
                ...
                public void execute() {
                    if (SecurityTaskManager.runningTasks == 0) {
                        ...
                        tasksLabel.setText(String.format("%s: %d", StatCollector.translateToLocal("gui.modularfluxfields:runningTasks"), SecurityTaskManager.runningTasks));
                    }
                }
            });
            ...
            final UITextButton undoButton = new UITextButton(tasksComponent,
                    "undoButton",
                    new PosXY(-GuiUtils.font.getWidth(StatCollector.translateToLocal("gui.modularfluxfields:undo")) - 24, 0),
                    new PosXY(0, 0),
                    new AnchorPoint(1, 0),
                    new AnchorPoint(1, 1));
            ...
            undoButton.uiLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:undo"));
            ...
            playerOptionsLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:playerOptions"));
            ...
            playerOptionsSetGroupButton.uiLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:assignToSelectedGroup"));
                    ...
                    if (selectedPlayerUUIDs.size() > 0) {
                        if (selectedGroupIDs.size() > 0) {
                            if (selectedGroupIDs.size() < 2) {
                                ...
                                notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:tooManyGroupsSelected"), UIColor.matRed());
                            }
                        } else {
                            notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:selectAGroup"), UIColor.matRed());
                        }
                    } else {
                        notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:selectPlayersToAssign"), UIColor.matRed());
                    }
                }
            });
            ...
            playerOptionsRemoveButton.uiLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:removePlayers"));
            playerOptionsRemoveButton.setOnClickAction(new UIAction() {
                ...
                public void execute() {
                    if (selectedPlayerUUIDs.size() > 0) {
                        ...
                        notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:selectPlayersToRemove"), UIColor.matRed());
                    }
                }
            });
            ...
            GroupOptionsLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:groupOptions"));
            ...
            final UITextField renameGroupTextField = new UITextField(null,
                    ...
                    new AnchorPoint(0, 0),
                    new AnchorPoint(1, 0));
            renameGroupTextField.setPlaceholderText(StatCollector.translateToLocal("gui.modularfluxfields:renameGroup"));
            ...
            groupSelectMembersButton.uiLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:selectMembersOfGroup"));
            groupSelectMembersButton.setOnClickAction(new UIAction() {
                ...
                public void execute() {
                    if (selectedGroupIDs.size() > 0) {
                        ...
                        notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:selectGroupsToSelectMembers"), UIColor.matRed());
                    }
                }
            });
            ...
            groupRemoveButton.uiLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:removeGroups"));
            groupRemoveButton.setOnClickAction(new UIAction() {
                ...
                public void execute() {
                    if (selectedGroupIDs.size() > 0) {
                        ...
                        for (String groupID : selectedGroupIDs) {
                            ...
                            for (Map.Entry<String, String[]> entry : permittedPlayers.entrySet()) { //Loop through all players
                                if (entry.getValue()[1].equals(groupID)) { //If that player is assigned to the current group
                                    entry.setValue(new String[]{entry.getValue()[0], "gui.modularfluxfields:everyone"}); //Assign that player to the everyone group
                                }
                            }
                        }
                        ...
                        notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:selectGroupsToRemove"), UIColor.matRed());
                    }
                }
            });
            ...
            final UILabel noSecurityUpgradeLabel = new UILabel(getWorkspace(),
                    ...
                    new AnchorPoint(0, 0),
                    GuiUtils.font);
            noSecurityUpgradeLabel.setText(StatCollector.translateToLocal("gui.modularfluxfields:securityNoUpgrade"));
        }
                                ...
                                SecurityTaskManager.addTask(new UIAction() {
                                    ...
                                    public void execute() {
                                        try {
                                            ...
                                            e.printStackTrace();
                                            notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:cantContactCrafatar"), UIColor.matRed());
                                        }
                                    }
                                });

                                notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:playerRegistered"), UIColor.matGreen());
                            } else {
                                //Show player already registered notification
                                notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:playerAlreadyRegistered"), UIColor.matRed());
                            }

                        } else {
                            notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:invalidResponseMojang"), UIColor.matRed());
                        }

                    } else {
                        notificationManager.addNotification(String.format("%s: %s", StatCollector.translateToLocal("gui.modularfluxfields:playerDoesNotExist"), playerName), UIColor.matRed());
                    }

                } catch (IOException e) {
                    e.printStackTrace();
                    notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:cantContactMojang"), UIColor.matRed());
                }
            }
        });
    ...
    private void addPlayer(final String playerName, final UIListBox playersListBox) {
        addPlayer(playerName, playersListBox, "gui.modularfluxfields:everyone", true);
    }
    ...
    private void addGroup(final String groupName, final UIListBox permGroupsListBox) {
        ...
        if (!permissionGroups.containsKey(groupName)) { //If the group doesn't exist
            ...
            notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:groupRegistered"), UIColor.matGreen());
        } else {
            //Show player already registered notification
            notificationManager.addNotification(StatCollector.translateToLocal("gui.modularfluxfields:groupAlreadyRegistered"), UIColor.matRed());
        }
    ...
    private PlayerData getAggregatePlayerData(List<String> selectedPlayerUUIDs) {
        ...
        if (selectedPlayerUUIDs.size() == 0) {
            ...
            playerData.name = StatCollector.translateToLocal("gui.modularfluxfields:nothingSelected");
            playerData.uuid = StatCollector.translateToLocal("gui.modularfluxfields:nothingSelected");
            playerData.group = StatCollector.translateToLocal("gui.modularfluxfields:nothingSelected");
    ...
    private GroupData getAggregateGroupData(List<String> selectedGroupIDs) {
        ...
        if (selectedGroupIDs.size() == 0) {
            ...
            groupData.name = StatCollector.translateToLocal("gui.modularfluxfields:nothingSelected");
...
//            }
    ...
    private void updateSecurityOptions() {
        ...
        playerOptionsNameLabel.setText(String.format("%s: %s", StatCollector.translateToLocal("gui.modularfluxfields:name"), aggregateSelectedPlayerData.name));
        playerOptionsUUIDLabel.setText(String.format("%s: %s", StatCollector.translateToLocal("gui.modularfluxfields:uuid"), aggregateSelectedPlayerData.uuid));
        playerOptionsGroupLabel.setText(String.format("%s: %s", StatCollector.translateToLocal("gui.modularfluxfields:group"), StatCollector.translateToLocal(aggregateSelectedPlayerData.group)));
        groupNameLabel.setText(String.format("%s: %s", StatCollector.translateToLocal("gui.modularfluxfields:name"), aggregateSelectedGroupData.name));
